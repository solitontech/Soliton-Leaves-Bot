import { applyLeave, getEmployeeByEmail, getEmployeeById, getEmployeeOrgTree } from "./greytHr-service/greytHrClient.js";
 ...
 */
export async function getLeaveEmail(
 ...
 */
export async function getEmployeeAndManagerDetails(
 ...
 */
export async function checkManagerApproval(
    threadMessages: EmailData[],
 ...
 * @param token - Graph API access token
 */
export async function sendLeaveApplicationFailureEmail(
    participantEmails: Set<string>,
    emailSubject: string,
    emailId: string,
    token: string
 ...
 */
export async function sendLeaveRequestParsingErrorEmail(
    participantEmails: Set<string>,
    emailSubject: string,
    emailId: string,
    token: string,
 ...
 */
export async function parseAndValidateLeaveRequest(
    leaveEmail: EmailData,
    participantEmails: Set<string>,
    emailSubject: string,
    emailId: string,
